...
int main()
{
    ...
    assert(shortcutActionForKey(WM_KEYDOWN, true, false, 'N') == MainWindowShortcutAction::NewConnection);
    assert(shortcutActionForKey(WM_KEYDOWN, true, true, 'N') == MainWindowShortcutAction::NewConnection);
    assert(shortcutActionForKey(WM_SYSKEYDOWN, true, false, 'N') == MainWindowShortcutAction::NewConnection);
    assert(shortcutActionForKey(WM_SYSKEYDOWN, true, true, 'N') == MainWindowShortcutAction::NewConnection);
    ...
    assert(isReservedMainWindowShortcut(true, true, 'N'));
