...
void applyApplicationStyle(QApplication &application)
{
    ...
    application.setStyleSheet(QStringLiteral(
        ...
        "#logoButton { background: transparent; border: 0; border-radius: 0; padding: 0; }"
        "#logoButton:hover { background: #e8edf4; }"
        "#logoButton:checked { background: #cb8306; }"
        "#versionButton { background: transparent; border: 0; color: #6b7280; padding: 0 10px; }"
        "#versionButton:hover { background: #e8edf4; color: #1f2328; }"
